...
COURSE_OPTIONS = [
    {
        ...
        "curso": "TRANCISTA",
        "turma": "TURMA 1.1",
        "local": "INSTITUTO ESTRELLA DE PRATTA",
        "dias_aula": "Segunda, Terça e Quarta",
        "horario": "10h às 17h",
        "data_inicio": "22/06/2026",
        "encerramento": "24/06/2026",
        "endereco_curso": "📍Av. Pastor Martin Luther King Jr., 5609 – Vicente de Carvalho",
    },
]

COURSE_OPTIONS_BY_ID = {option["id"]: option for option in COURSE_OPTIONS}
COURSE_INFO = COURSE_OPTIONS[0]
WHATSAPP_SHARE_HOME_URL = "https://mulheres-do-corre-2.onrender.com"


def build_whatsapp_share_url():
    message = (
        "Acabei de me inscrever no programa Mulheres do Corre 2, com cursos gratuitos de "
...
<head>
    ...
    <title>Mulheres do Corre 2</title>
        ...
        <div class="wizard-shell">
            <form id="wizard-form" method="POST"
                ...
                <section class="wizard-panel" data-step="index">
                    <div class="hero-grid">
                        <div class="hero-card">
                            <span class="hero-pill">PROGRAMA: MULHERES DO CORRE 2</span>
                            <h1 class="hero-title">MULHERES DO CORRE 2</h1>
                        ...
                        <div class="review-layout">
                            ...
                            <div class="review-box full">
                                <div class="review-info-text"
                                    ...
                                    qualificação profissional do programa Mulheres do Corre 2.
                                </div>
                                ...
                                <label class="review-check" for="confirma_dados">
                                    ...
                                    <span>
                                        Confirmo que tenho interesse em participar do programa Mulheres do Corre 2
